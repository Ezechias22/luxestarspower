            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin-bottom: 40px;">
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 15px; margin-top: 20px;">
                        ...
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" style="color: #1DA1F2; font-size: 1.8rem; transition: transform 0.3s;" title="Twitter">
                        ...
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" style="color: #E1306C; font-size: 1.8rem; transition: transform 0.3s;" title="Instagram">
                        ...
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" style="color: #0077b5; font-size: 1.8rem; transition: transform 0.3s;" title="LinkedIn">
